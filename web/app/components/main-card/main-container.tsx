                ...
                <div className="justify-start">
                    <div className="flex py-1 border-t-2 px-1 ">
                        <div className="relative w-full aspect-video">
                            ...
                            />
                            <button
                                className="absolute top-1 left-1/2 -translate-x-1/2 z-10 pixel-btn-white hover:animate-pulse text-xs w-[calc(100%-0.5rem)]"
                                onClick={() => onOpenCard?.("firstTracker")}
                            >
                                first in stream
                            </button>
                            <button
                                className="absolute top-1 my-6 left-1/2 -translate-x-1/2 z-10 pixel-btn-white hover:animate-pulse text-xs w-[calc(100%-0.5rem)]"
