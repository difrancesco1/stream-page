            ...
            <div className="flex gap-1 py-[2] px-1">
                <a href="https://www.twitch.tv/rosie" target="_blank" rel="noopener noreferrer">
                    <div className="p-0.5 flex items-center justify-center w-[18] h-5">
                        <i className="hn hn-twitch text-border hover:animate-bounce pixel-borders bg-background" />
                    </div>
                </a>
                <a href="https://x.com/ttvrosie" target="_blank" rel="noopener noreferrer">
                    <div className="p-0.5 flex items-center justify-center w-[18] h-5">
                        <i className="hn hn-twitter text-border hover:animate-bounce pixel-borders bg-background" />
                    </div>
                </a>

                <a href="https://www.tiktok.com/@ttvrosie" target="_blank" rel="noopener noreferrer">
                    <div className="p-0.5 flex items-center justify-center w-[18] h-5">
                        <i className="hn hn-tiktok text-border hover:animate-bounce pixel-borders bg-background" />
                    </div>
                </a>
                <a href="https://www.youtube.com/@ttvrosie" target="_blank" rel="noopener noreferrer">
                    <div className="p-0.5 flex items-center justify-center w-[18] h-5">
                        <i className="hn hn-youtube text-border hover:animate-bounce pixel-borders bg-background" />
                    </div>
                </a>
                <a href="https://vgen.co/rosieuna" target="_blank" rel="noopener noreferrer">
                    <div className="p-0.5 flex items-center justify-center w-[18] h-5">
                        <i className="hn hn-highlight text-border hover:animate-bounce pixel-borders bg-background" />
                    </div>
                </a>
            </div>
        </div>
