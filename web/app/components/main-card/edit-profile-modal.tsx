...
export default function EditProfileModal({
    ...
    useEffect(() => {
        if (profile && open) {
            ...
            setProfilePicPreview(profile.profile_picture ? getImageUrl(profile.profile_picture) : null);
            setFeaturedPreview(profile.featured_image ? getImageUrl(profile.featured_image) : null);
        ...
        try {
            ...
            if (profilePicFile) {
                ...
                if (!picResult.success) {
                    throw new Error(picResult.error || "Failed to upload profile picture");
                }
            }
            ...
            if (featuredFile) {
                ...
                if (!featuredResult.success) {
                    throw new Error(featuredResult.error || "Failed to upload featured image");
                }
            }
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-foreground pixel-borders max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-4 space-y-4">
                    {/* Biography Section */}
                    <div>
                        <label className="main-text text-xs block mb-2">About (2 bullet points):</label>
                        <input
                            value={bio1}
                    ...
                    {/* Birthday Section */}
                    <div>
                        <label className="main-text text-xs block mb-2">Birthday (MM/DD):</label>
                        <input
                            value={birthday}
                    ...
                    <div>
                        <label className="main-text text-xs block mb-2">Profile Picture:</label>
                    ...
                    <div>
                        <label className="main-text text-xs block mb-2">Featured Image:</label>
                    ...
                    <div>
                        <label className="main-text text-xs block mb-2">Social Links:</label>
