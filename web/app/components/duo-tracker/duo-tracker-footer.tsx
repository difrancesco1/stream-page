...
export default function DuoTrackerFooter({
    isRosie, since, account, accountLoading,
    onAdd, onSetAccount, onUpdateAccount, onOpenOpgg,
    ...
    if (!isRosie) {
        return (
            <div className="px-[var(--spacing-md)] w-full h-[1.75rem] flex items-center border-t-2 gap-[var(--spacing-md)]">
                ...
                <button className="main-text truncate opacity-70">
                    {since ? `since ${since}` : "\u00A0"}
                </button>
            </div>
        )
    ...
    return (
        <div className="flex flex-col border-t-2">
            ...
            <div className="px-[var(--spacing-sm)] w-full h-[1.25rem] flex items-center gap-[var(--spacing-sm)]">
                ...
                <span className="main-text text-xs opacity-30">{account.match_count}g</span>
                <button
